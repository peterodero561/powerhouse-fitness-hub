  ...
  return (
    <div className="min-h-screen bg-[#0F1108] text-white">
      ...
      >
        ...
        {/* floating Google Maps button (keeps position while scrolling) */}
        <FloatingMapButton
          mapsUrl={"https://www.google.com/maps/search/?api=1&query=PowerHouse+Gym+Nakuru"}
          label={"PowerHouse Gym — NaKuru"}
          topOffsetClass={"top-20"} // tweak if needed
        />
      ...
      <section id="contact" className="py-20 px-6 lg:px-12 bg-[#0F1108]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* WhatsApp Contact */}
            <a href="https://wa.me/+254729284775" className="group" target='_blank' rel='noopener noreferrer'>
